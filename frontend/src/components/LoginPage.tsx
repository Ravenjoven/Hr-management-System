...
const Login = () => {
  return (
    <div className="flex flex-col h-screen justify-between min-h-screen max-w-screen  bg-white font-montserrat">
      <>
        ...
        <section className="ml-[150px] mr-[150px]">
          ...
          {/* <div className="w-full flexpl-5 pt-2">
            <svg
    ...
    // <div className="w-full relative bg-white overflow-hidden flex flex-col items-end justify-start pt-[79px] px-0 pb-0 box-border gap-[114px_0px] tracking-[normal] mq750:gap-[114px_0px] mq450:gap-[114px_0px]">
    //   <section className="w-[1345px] flex flex-row items-start justify-start py-0 px-[58px] box-border max-w-full lg:pl-[29px] lg:pr-[29px] lg:box-border">
    //     <div className="flex-1 flex flex-col items-start justify-start gap-[45px_0px] max-w-full mq750:gap-[45px_0px]">
    //       <div className="w-[1135px] flex flex-row items-end justify-start pt-9 px-0 pb-[23px] box-border sticky gap-[0px_484px] top-[0] z-[99] max-w-full text-left text-xl text-darkorange-100 font-montserrat mq750:w-[891px] mq750:gap-[0px_484px] mq1050:gap-[0px_484px]">
    //         <div className="h-full w-full absolute my-0 mx-[!important] top-[0px] right-[0px] bottom-[0px] left-[0px] [filter:drop-shadow(0px_4px_100px_rgba(0,_0,_0,_0.25)_inset)]" />
    //         <img
    //           className="h-16 w-[253px] relative object-cover z-[1]"
    //           loading="lazy"
    //           alt=""
    //           src="/teravault-1@2x.png"
    //         />

    //         <div className="w-[244px] flex flex-row items-start justify-between gap-[20px] mq750:hidden">
    //           <h2 className="m-0 relative text-inherit font-medium font-inherit z-[1]">
    //             Home
    //           </h2>
    //           <h2 className="m-0 relative text-inherit font-medium font-inherit text-gray whitespace-nowrap z-[1]">
    //             About us
    //           </h2>
    //         </div>
    //         <h2 className="my-0 mx-[!important] absolute right-[-16px] bottom-[23px] text-inherit font-medium font-inherit text-gray z-[1]">
    //           Contact
    //         </h2>
    //       </div>
    //       <div className="self-stretch flex flex-row items-end justify-between max-w-full gap-[20px] text-left text-16xl text-gray font-montserrat mq1050:flex-wrap">
    //         <div className="w-[589px] flex flex-col items-start justify-start pt-0 px-0 pb-[13px] box-border min-w-[589px] max-w-full mq750:min-w-full mq1050:flex-1">
    //           <h1 className="m-0 self-stretch relative text-inherit font-bold font-inherit mq450:text-2xl mq1050:text-9xl">
    //             We’re passionate about helping entrepreneurs change the world
    //             and build a better tomorrow.
    //           </h1>
    //         </div>
    //         <form className="m-0 w-[341px] rounded-tl-none rounded-tr-31xl rounded-br-none rounded-bl-31xl bg-darkorange-300 shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] flex flex-col items-center justify-start pt-[139px] pb-[115px] pr-[60px] pl-[61px] box-border gap-[29px] min-w-[341px] max-w-full mq750:min-w-full mq450:pt-[90px] mq450:px-5 mq450:pb-[75px] mq450:box-border mq1050:flex-1">
    //           <div className="w-[341px] h-[455px] relative rounded-tl-none rounded-tr-31xl rounded-br-none rounded-bl-31xl bg-darkorange-300 shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] hidden max-w-full" />
    //           <div className="self-stretch rounded-mini bg-whitesmoke flex flex-row items-center justify-start py-[11px] px-2.5 z-[1] border-[1px] border-solid border-gainsboro-200">
    //             <div className="h-[38px] w-[220px] relative rounded-mini bg-whitesmoke box-border hidden border-[1px] border-solid border-gainsboro-200" />
    //             <input
    //               className="w-[105px] [border:none] [outline:none] font-thin font-montserrat text-xs bg-[transparent] h-4 relative text-black text-left inline-block whitespace-nowrap z-[2]"
    //               placeholder="Email@gmail.com"
    //               type="text"
    //             />
    //           </div>
    //           <div className="self-stretch flex flex-col items-end justify-start gap-[14px_0px]">
    //             <div className="self-stretch rounded-mini bg-whitesmoke flex flex-row items-center justify-start py-[11px] px-[15px] z-[1] border-[1px] border-solid border-gainsboro-200">
    //               <div className="h-[38px] w-[220px] relative rounded-mini bg-whitesmoke box-border hidden border-[1px] border-solid border-gainsboro-200" />
    //               <input
    //                 className="w-[52px] [border:none] [outline:none] font-thin font-montserrat text-xs bg-[transparent] h-4 relative text-black text-left inline-block z-[2]"
    //                 placeholder="Password"
    //                 type="text"
    //               />
    //             </div>
    ...
    //             </div>
    //           </div>
    //           <button className="cursor-pointer pt-2 pb-[9px] pr-3.5 pl-[15px] bg-darkorange-200 w-[89px] rounded-3xs box-border flex flex-row items-center justify-center whitespace-nowrap z-[1] border-[1px] border-solid border-white hover:bg-chocolate hover:box-border hover:border-[1px] hover:border-solid hover:border-gainsboro-100">
    //             <div className="h-9 w-[89px] relative rounded-3xs bg-darkorange-200 box-border hidden border-[1px] border-solid border-white" />
    //             <b className="relative text-base font-inter text-whitesmoke text-left z-[2]">
    //               SIgn in
    //             </b>
    ...
    //   </section>
    //   <img
    //     className="w-[983px] h-[553px] absolute my-0 mx-[!important] top-[112px] left-[-185px] object-cover z-[2]"
    //     alt=""
    //     src="/728101removebgpreview-2@2x.png"
    //   />
    //   <footer className="self-stretch bg-darkgray flex flex-col items-center justify-start pt-[35px] px-3.5 pb-3.5 box-border gap-[24px_0px] max-w-full text-left text-xs text-white font-inter">
    //     <div className="self-stretch h-[198px] relative bg-darkgray hidden" />
    //     <img
    //       className="w-[90px] h-[101px] relative object-cover z-[1]"
    //       loading="lazy"
    //       alt=""
    //       src="../images/img2.png"
    //     />
    //     <b className="w-[520px] h-6 relative inline-block shrink-0 max-w-full box-border pl-5 pr-5 z-[1] text-black">
    //       Copyright © 2024 TERAVAULT, INC. dba TeraVault Software. All rights
    //       reserved
    //     </b>
    //   </footer>
    // </div>
