  ...
  return (
    <div>
      {/* <button
        ...
        className={`cursor-pointer ml-52 z-50 inline-flex items-center p-2 text-sm text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white
        ${expanded ? "ml-2" : "ml-52"}`}
      >
      ...
      <aside
        className={`border-[3px] rounded-tr-2xl sm:hidden md:block bg-white overflow-hidden border-custom-text-orange fixed mt-28 top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 ${
          expanded ? "w-0" : "w-64"
        }`}
      >
        ...
        <ol className="space-y-2 font-medium">
          <li className="cursor-pointer flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <span className={`block ${expanded ? "hidden" : "block"}`}>
              {" "}
              Dashboard
            </span>{" "}
          </li>
          ...
          <li>
            ...
            >
              ...
              <span
                className={`text-sm block ${expanded ? "hidden" : "blocks"}`}
              >
                Employee Management
              </span>
            </a>
            {isOpen && (
              <ul className="text-sm border-t-2 border-b-2 shadow-inner shadow-gray-500">
                <div className="pl-[50px] space-y-2 py-2">
        ...
        <div className="mt-20 cursor-pointer flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
          ...
          <span
            className={`text-custom-text-gray font-semibold ${
