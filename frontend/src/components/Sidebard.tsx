...
function Sidebar() {
  ...
  return (
    <aside
      className={`border-[3px] rounded-tr-2xl bg-white  border-custom-text-orange fixed mt-28 top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 ${
        expanded ? "w-0" : "w-64"
      }`}
    >
      <button
        ...
        className={`cursor-pointer ml-52 inline-flex items-center p-2 text-sm text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white
        ${expanded ? "ml-0 pl-4" : "ml-52"}`}
      >
      ...
      <ol className="space-y-2 font-medium">
        ...
        <li>
          ...
          >
            ...
            <span className={`text-sm block ${expanded ? "hidden" : "blocks"}`}>
              Employee Management
            </span>
          </a>
          {isOpen && (
