          ...
          >
            <div className="upper-div md:min-w-full h-full font-bol rounded flex bg-white text-black p-4">
              ...
              <div className="flex flex-col m-12">
                ...
                <span className="text-custom-text-gray font-semibold">johndoe@gmail.com</span>
                </div>
                <div>
                <h4 className="text-custom-text-black font-bold">NUMBER</h4>
                <span className="text-custom-text-gray font-semibold">1234567890</span>
                </div>
              </div>
              <div className="flex flex-col m-12">
                <div>
                <h4 className="text-custom-text-black font-bold">MENTOR</h4>
                <span className="text-custom-text-gray font-semibold">johndoe</span>
                </div>
                <div>
                <h4 className="text-custom-text-black font-bold">SCHEDULE</h4>
                <span className="text-custom-text-gray font-semibold">6am - 3pm</span>
                </div>
              </div>
            </div>
            <div className="flex">
